...
<head>
	...
	<link rel="canonical" href="http://preview.keenthemes.comHondurasl" />
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
						...
						<?php
			  			 ...
			  			 include("../demo1/Navigation/MenuHeader.php");
 						?>
							<!--end::Menu-->
						</div>
						<!--end::Menu wrapper-->
						...
						<?php
			  			 ...
			  			 include("../demo1/Navigation/LoginHeader.php");
 						?>
						</div>
						<!--end::Navbar-->
					</div>
			...
			<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper" >
				...
				<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
					...
					<?php
			  			 ...
			  			 include("../demo1/Navigation/Logo.html");
 					?>
					</div>
					<!--end::Logo-->
					<!--begin::sidebar menu-->
					...
					<?php
			   					...
			   					include("../demo1/Navigation/Menu.html");
			 		?>
					</div>
					<!--end::sidebar menu-->
					<!--begin::Footer-->
				...
				<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
					...
					<div class="d-flex flex-column flex-column-fluid">
						...
						<div id="kt_app_content" class="app-content flex-column-fluid">
                          ...
                          background-image: url('assets/media/svg/shapes/widget-bg-1.png');
                        ">
											<!--begin::Header-->
                          ...
                          background-image: url('assets/media/svg/shapes/widget-bg-2.png');
                        " data-bs-theme="light">
											<!--begin::Body-->
											<div
												...
												<div class="mb-10">
													...
													<div class="text-center">
														<a href="#"
															...
															data-bs-target="#kt_modal_upgrade_plan">Get Started</a>
													</div>
													<!--begin::Action-->
												</div>
												<!--begin::Wrapper-->
